...
import (
	...
	"github.com/ffhenkes/vulcand/proxy/connctr"
	"github.com/ffhenkes/vulcand/proxy/frontend"
	"github.com/ffhenkes/vulcand/proxy/rtmcollect"
	"github.com/ffhenkes/vulcand/proxy/server"
...
type mux struct {
	...
	//Cache to store AutoCert data (e.g. certificates generated by Let's Encrypt)
...
func setDefaults(o proxy.Options) proxy.Options {
	...
	if o.CacheProvider == nil {
		o.CacheProvider = cacheprovider.NoOp()
	}
	return o
}
